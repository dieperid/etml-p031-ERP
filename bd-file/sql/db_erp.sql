...
-- SQLINES DEMO *** ds region information for locations
-- SQLINES DEMO *** e has a foreign key to this table. 
...
-- SQLINES DEMO *** olds country information for customers and company locations. 
-- SQLINES DEMO *** e and HR.LOCATIONS have a foreign key to this table.
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** olds address information for company departments. 
-- SQLINES DEMO *** s a foreign key to this table. 
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** bsequent addition of rows to LOCATIONS table 
-- Starts with 3300 
...
-- SQLINES DEMO ***  holds company department information. 
-- SQLINES DEMO *** HR.JOB_HISTORY have a foreign key to this table.
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** bsequent addition of rows to DEPARTMENTS table
-- Starts with 280 
...
-- SQLINES DEMO *** the different names of job roles within the company. 
-- SQLINES DEMO *** a foreign key to this table. 
-- SQLINES LICENSE FOR EVALUATION USE ONLY
CREATE TABLE jobs(
    job_id VARCHAR(10),
...
-- SQLINES DEMO *** olds the employee personnel  information for the company. 
-- SQLINES DEMO *** a self referencing foreign key to this table.
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** an now be created to the EMPLOYEES table.
...
-- SQLINES DEMO *** bsequent addition of rows to employees table.
-- Starts with 207  
...
-- SQLINES DEMO ***  holds the history of jobs that employees have held in the past.
-- SQLINES DEMO *** TMENTS, and HR.EMPLOYEES have a foreign key to this table.
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** joins the employees, jobs, departments, jobs, countries, and locations table to provide details about employees.
...
-- SQLINES DEMO *** the REGIONS table
...
-- SQLINES DEMO *** the COUNTRIES table 
...
-- SQLINES DEMO *** the LOCATIONS table
...
-- SQLINES DEMO ***  constraint to EMPLOYEES to load data
-- ALTER TABLE departments   
  -- DISABLE CONSTRAINT dept_mgr_fk;

-- SQLINES DEMO *** the DEPARTMENTS table
...
-- SQLINES DEMO *** the EMPLOYEES table 1 
...
-- SQLINES DEMO *** the EMPLOYEES table 2
-- SQLINES DEMO ***  10k limit per statement
INSERT INTO employees VALUES     
        ( 120    
        , 'Matthew'    
        , 'Weiss'    
...
-- SQLINES DEMO *** the EMPLOYEES table 3
-- SQLINES DEMO ***  10k limit per statement 
INSERT INTO employees VALUES     
        ( 130    
        , 'Mozhe'    
...
-- SQLINES DEMO *** the EMPLOYEES table 4
INSERT INTO employees VALUES     
        ( 150    
        , 'Peter'    
        , 'Tucker'    
...
-- SQLINES DEMO *** the EMPLOYEES table 5
-- SQLINES DEMO ***  10k limit per statement
...
-- SQLINES DEMO *** the EMPLOYEES table 6
-- SQLINES DEMO ***  10k limit per statement
...
-- SQLINES DEMO *** the JOB_HISTORY table
...
-- SQLINES DEMO *** constraint to DEPARTMENTS
-- ALTER TABLE departments   
  -- ENABLE CONSTRAINT dept_mgr_fk;

-- -- SQLINES DEMO *** t edit of EMPLOYEES to normal office hours
-- -- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** EES to invoke the SECURE_DML procedure
...
-- -- SQLINES DEMO *** PLOYEES trigger so data can be used at any time (given that this is a sample schema)
-- ALTER TRIGGER secure_employees DISABLE;

-- -- SQLINES DEMO *** a row to the JOB_HISTORY table
-- -- SQLINES LICENSE FOR EVALUATION USE ONLY
...
-- SQLINES DEMO *** ll the ADD_JOB_HISTORY procedure when data is updated in the job_id or department_id columns in the EMPLOYEES table
...
-- SQLINES DEMO *** ents on tables and columns
ALTER TABLE regions   
...
COMMENT 'Locations table that contains specific address of a specific office, warehouse, and/or production site of a company. Does not store addresses or locations of customers. Contains 23 rows; references with the departments and countries tables. ';
